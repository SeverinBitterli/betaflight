...
// PG_PID_PROFILE
    ...
    { "adrc_ctrl_freq_roll",    VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, adrc_ctrl_freq[FD_ROLL]) },
    { "adrc_ctrl_freq_pitch",   VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, adrc_ctrl_freq[FD_PITCH]) },
    { "adrc_ctrl_freq_yaw",     VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, adrc_ctrl_freq[FD_YAW]) },
